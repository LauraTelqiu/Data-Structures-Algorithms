...
// - Create an empty array, then look at values in each array, insert the smallest values of each input
// array into our empty array(we are going to use a while loop; we will keep track of each variable using
//   i and j start; both start at 0)
...
//       - You can use slice from 0 to the middle of the array, and then from the middle of the
// array until the end(making two halves)
...
// back at the full length of the array(using the merge helper function we have already written)
